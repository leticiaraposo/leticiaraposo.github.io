##%######################################################%##
#                                                          #
####  TEMAS DIFERENTES PARA GRÁFICOS FEITOS COM GGPLOT  ####
#                                                          #
##%######################################################%##
...
p + theme_wsj() #tema do The Wall Street Journal
...
pomological_mtcars <- p + theme_pomological(base_family = "Homemade Apple", base_size = 16) +
