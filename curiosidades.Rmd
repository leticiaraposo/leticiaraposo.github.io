...
<h4>Addins do RStudio</h4>

Já ouviu falar dos *Addins*? Os *Addins* são interfaces desenvolvidas com Shiny voltadas para facilitar a execução de algumas funções. [Aqui](https://github.com/daattali/addinslist) você encontra uma lista dos *addins* disponíveis e um [script](https://drive.google.com/file/d/1J56bqbUdWQZOWEyDrd591G1HpWWAErSF/view?usp=sharing) contendo alguns *addins* interessantes já separados para vocês instalar.
<br>
...
<p>Quem nunca buscou um joguinho para distrair a mente, hein?! Com o pacote Shiny do RStudio é possível construir alguns. Aproveite os que já estão disponíveis e se distraia um pouco! Você merece! ;)
<br>
<br>

<ul class="fa-ul">
<li><i class="fas fa-gamepad"></i> [Campo Minado](https://dgranjon.shinyapps.io/deminR/_w_6cbbd0ed/)</li>
<li><i class="fas fa-gamepad"></i> [Jogo da Memória](http://shinyapps.dreamrs.fr/memory-hex/)</li>
<li><i class="fas fa-gamepad"></i> [Jogo de Luzes](https://daattali.com/shiny/lightsout/)</li>
<li><i class="fas fa-gamepad"></i> [Onde está o país?](https://dreamrs.shinyapps.io/where-is-this-country/)</li>
</ul>
...
<ul class="fa-ul">
<li><i class="fas fa-file-image"></i> Imagem como gráfico de pontos: [Script](https://drive.google.com/file/d/1dQvQL_5bHv5iJekauarLuvx1hvr9xa83/view?usp=sharing), [App](https://rpodcast.shinyapps.io/shinylego/_w_8e06c828/)</li>
...
<h4>Raspagem de Dados da Internet (Web Scraping)</h4>

Se você tem interesse em aprender a raspar dados da internet com o R, este tutorial é para você. Clique neste [link](https://drive.google.com/file/d/1eRjP3m8HTcfypwqR_VCzR99s-rHrYKwV/view?usp=sharing), baixe o Rmarkdown e acompanhe o passo-a-passo com um exemplo bem divertido.